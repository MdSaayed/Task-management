            ...
            <div className="flex items-center justify-center h-screen w-full max-w-6xl mx-auto">
                <div className='bg-white dark:bg-[#26272D] p-8 rounded shadow-md z-30'>
                    ...
                    ">
                        ...
                        <div className="mb-6">
                            <input className='bg-[#31A0FE] text-white  py-2 w-full rounded-sm cursor-pointer' type="submit" value="SignUp" />
                        </div>
                    </form>
                    <div>
                        <p className='text-center dark:text-white'>Already have an account? <Link to={'/signin'} className='cursor-pointer text-[#31A0FE]'>SignIn here</Link></p>
                    </div>
                </div>
            </div>
        </div>
