    ...
    return (
        <div className="max-w-6xl mx-auto py-16">
            <div className="flex items items-center justify-center flex-col gap-4">
                <p className="text-[#252B42]">Contact</p>
                <h2 className="text-[#252B42] text-4xl font-bold">Conctact Us</h2>
            ...
            <div className='py-8'>
                <form >
                    ...
                    <div className="flex justify-center">
                        <input className='text-white bg-[#31A0FE] mt-6 rounded-md py-2 px-8 text-center' type="submit" value="Send Message" />
                    </div>
                </form>
            </div>
            <div className='my-12'>
